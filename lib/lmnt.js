"use server";
// This file has all server actions needed for using chatGPT and lmnt api //
import { OpenAI } from "openai";
// Imports to accessing the database
...
// Takes voiceid as parametr and sets it as coach for current user
